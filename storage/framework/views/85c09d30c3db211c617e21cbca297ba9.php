...
<head>
    ...
    <title>Kiosk | <?php echo e($appSetting->app_name ?? 'E-Pilketos'); ?></title>
    ...
    <?php endif; ?>
    <?php if(isset($appSetting) && is_array($appSetting->dynamic_color_tags)): ?>
    <style>
        <?php $__currentLoopData = $appSetting->dynamic_color_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!empty($tagData['tag'])): ?>
            .<?php echo e($tagData['tag']); ?> { 
                background-color: <?php echo e($tagData['bg_color'] ?? 'transparent'); ?> !important; 
    ...
    <?php endif; ?>
    <link href="<?php echo e(asset('Assets/vendor/plus-jakarta-sans.css')); ?>" rel="stylesheet">
    ...
    <style>
        body {
            ...
            color: <?php echo e($appSetting->theme_color_4 ?? '#ffffff'); ?>;
            min-height: 100vh;
            display: flex;
        ...
        .timer-badge {
            background: <?php echo e($appSetting->theme_color_3 ?? '#f59e0b'); ?>;
            color: #1e293b;
        ...
        .progress-fill {
            height: 100%;
            background-color: <?php echo e($appSetting->theme_color_3 ?? '#f59e0b'); ?>;
            border-radius: 6px;
...
<body>
    ...
    <div class="container">
        ...
        <div class="header-section animate-up" style="display: flex; align-items: center; justify-content: center; gap: 2rem; flex-wrap: wrap;">
            ...
            <div class="header-logo" style="width: 180px; flex-shrink: 0;">
                <?php if(isset($appSetting) && $appSetting->osim_logo): ?>
                    <img src="<?php echo e($appSetting->osim_logo); ?>" alt="Logo OSIM" style="width: 100%; height: auto; border-radius: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                <?php else: ?>
            ...
            <div class="header-text" style="text-align: left;">
                <h1 class="login-title" style="margin-bottom: 0.5rem; margin-top: 0;"><?php echo e($appSetting->header_title ?? 'LOGIN HAK PILIH'); ?></h1>
                <h2 class="school-name" style="margin-top: 0;"><?php echo e($appSetting->election_title ?? 'Pemilihan Ketua OSIS'); ?><br><?php echo e($appSetting->school_name ?? 'Nama Madrasah Belum Diatur'); ?></h2>
                <?php if(!empty($appSetting->period)): ?>
                    <h3 style="font-size: 1.25rem; font-weight: 600; opacity: 0.9; margin-top: 0.5rem; margin-bottom: 0;">Periode <?php echo e($appSetting->period); ?></h3>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <div class="result-card">
                                ...
                                <div class="result-info">
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                                        <span style="font-size: 1.25rem; font-weight: 800; color: white;"><?php echo e($candidate->votes); ?> Suara</span>
                                        <span style="font-weight: 700; color: <?php echo e($appSetting->theme_color_3 ?? '#f59e0b'); ?>;"><?php echo e($percentage); ?>%</span>
                                    </div>
        ...
        <div class="instruction-bottom animate-up" style="animation-delay: 0.4s; text-align: center; margin-top: 2rem; background: rgba(0,0,0,0.2); padding: 0.75rem 1.5rem; border-radius: 1rem; border: 1px solid rgba(255,255,255,0.1); box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
            <p class="instruction-text" style="font-size: 1.35rem; line-height: 1.6; opacity: 0.95; margin: 0;">
                Silakan buka halaman utama di HP Anda, klik <strong style="color: <?php echo e($appSetting->theme_color_3 ?? '#f59e0b'); ?>; font-weight: 800;">"Mulai Memilih"</strong>, lalu arahkan kamera ke QR Code ini.
            </p>
        </div>
    </div>
    ...
    <div class="running-text-container">
        <div class="running-text-content">
            <?php echo e($appSetting->running_text ?? 'Selamat Datang di Pemilihan Ketua OSIM. Gunakan hak suara Anda dengan jujur, adil, bebas, dan rahasia!'); ?>
    ...
    <script>
        ...
        function startPolling() {
            pollInterval = setInterval(() => {
                ...
                fetch(`<?php echo e(route("kiosk.status")); ?>?token=${currentToken}`)
                    .then(res => res.json())
                    .then(data => {
                        if (data.status === 'used') {
...
<?php /**PATH D:\1Laravel\pilkasim\resources\views/kiosk/index.blade.php ENDPATH**/ ?>