<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('install.process_setup')); ?>" method="POST" id="setupForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="app_name" class="form-control" placeholder="Misal: E-Pilketos" value="<?php echo e(old('app_name', 'E-Pilketos')); ?>" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="admin_name" class="form-control" placeholder="Administrator" value="<?php echo e(old('admin_name', 'Administrator')); ?>" required>
        </div>
        
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
            <div class="form-group">
                <label>Username Login</label>
                <input type="text" name="admin_username" class="form-control" placeholder="admin" value="<?php echo e(old('admin_username', 'admin')); ?>" required>
            </div>
...
<?php echo $__env->make('install.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1Laravel\pilkasim\resources\views\install\step3.blade.php ENDPATH**/ ?>