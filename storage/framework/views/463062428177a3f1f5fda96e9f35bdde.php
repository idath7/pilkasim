    ...
    <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
        <div>
            <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                ...
                <?php if(!empty($setting->period)): ?>
                    <span style="background: rgba(255,255,255,0.2); padding: 0.25rem 0.75rem; border-radius: 100px; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.5px; border: 1px solid rgba(255,255,255,0.3); white-space: nowrap;">Periode <?php echo e($setting->period); ?></span>
                <?php endif; ?>
            </div>
            <p class="dashboard-admin-subtitle" style="margin: 0.5rem 0 0 0; color: rgba(255, 255, 255, 0.9);">Halo, <?php echo e(Auth::guard('admin')->user()->name ?? 'Administrator'); ?></p>
        </div>
        <a href="<?php echo e(route('admin.dashboard')); ?>" style="background: rgba(255, 255, 255, 0.2); color: white; border: 1px solid rgba(255, 255, 255, 0.4); border-radius: 8px; display: flex; flex-direction: column; align-items: center; justify-content: center; width: 60px; height: 60px; line-height: 1; padding: 0; text-decoration: none; transition: all 0.2s;" onmouseover="this.style.background='rgba(255, 255, 255, 0.3)'" onmouseout="this.style.background='rgba(255, 255, 255, 0.2)'">
    ...
    <div style="margin-top: 1.5rem; border-top: 1px solid rgba(255, 255, 255, 0.2); padding-top: 1.5rem;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem;">
            ...
            <div class="kiosk-buttons" style="display: flex; gap: 0.5rem; flex-wrap: wrap; justify-content: flex-end;">
                <a href="<?php echo e(route('kiosk')); ?>" target="_blank" class="btn btn-secondary" style="background: rgba(255,255,255,0.2); color: white; border: 1px solid rgba(255,255,255,0.4); font-size: 0.75rem; padding: 0.4rem 0.75rem; border-radius: 4px;">
...
<div class="stat-grid animate-fade-in" style="animation-delay: 0.1s">
    <div class="card stat-card">
        ...
        <div>
            <div class="stat-value"><?php echo e($totalStudentVoters + $totalTeacherVoters); ?></div>
            <div class="stat-label">Total Pemilih (<?php echo e($totalStudentVoters); ?> Siswa, <?php echo e($totalTeacherVoters); ?> Guru)</div>
        </div>
    </div>
    ...
    <div class="card stat-card">
        ...
        <div>
            <div class="stat-value"><?php echo e($votedStudentCount + $votedTeacherCount); ?></div>
            <div class="stat-label">Sudah Memilih (<?php echo e($votedStudentCount); ?> Siswa, <?php echo e($votedTeacherCount); ?> Guru)</div>
        </div>
    </div>
    ...
    <div class="card stat-card">
        ...
        <div>
            <div class="stat-value"><?php echo e($unvotedStudentCount + $unvotedTeacherCount); ?></div>
            <div class="stat-label">Belum Memilih (<?php echo e($unvotedStudentCount); ?> Siswa, <?php echo e($unvotedTeacherCount); ?> Guru)</div>
        </div>
    </div>
</div>
...
<div class="results-grid animate-fade-in" style="animation-delay: 0.2s">
    ...
    ?>
    <?php $__currentLoopData = $candidates->sortByDesc('votes'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card result-card">
            ...
            ?>
            <img src="<?php echo e($photoPath); ?>" alt="<?php echo e($candidate->name); ?>" class="result-photo" onerror="this.src='<?php echo e(asset('Assets/images/default-avatar.svg')); ?>'">
            
            <div class="result-info">
                <div class="result-name"><?php echo e($candidate->name); ?></div>
                <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                    <span style="font-size: 1.5rem; font-weight: 700; color: var(--primary);"><?php echo e($candidate->votes); ?> Suara</span>
                    <span style="font-weight: 600; color: var(--text-muted);"><?php echo e($percentage); ?>%</span>
                </div>
                
                <div class="progress-bar">
                    <div class="progress-fill" style="width: 0%;" data-width="<?php echo e($percentage); ?>%"></div>
                </div>
            </div>
        </div>
...
<div class="animate-fade-in" style="animation-delay: 0.3s; margin-top: 3rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
        ...
        <a href="<?php echo e(route('admin.voters')); ?>" class="card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem 1rem; text-decoration: none; transition: all 0.3s ease; text-align: center; border: 1px solid var(--border);">
        ...
        <a href="<?php echo e(route('admin.teachers')); ?>" class="card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem 1rem; text-decoration: none; transition: all 0.3s ease; text-align: center; border: 1px solid var(--border);">
        ...
        <a href="<?php echo e(route('admin.candidates')); ?>" class="card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem 1rem; text-decoration: none; transition: all 0.3s ease; text-align: center; border: 1px solid var(--border);">
        ...
        <a href="<?php echo e(route('admin.settings')); ?>" class="card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem 1rem; text-decoration: none; transition: all 0.3s ease; text-align: center; border: 1px solid var(--border);">
        ...
        <a href="<?php echo e(route('admin.users')); ?>" class="card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem 1rem; text-decoration: none; transition: all 0.3s ease; text-align: center; border: 1px solid var(--border);">
...
<script>
    ...
    function copyKioskLink() {
        const kioskUrl = '<?php echo e(route("kiosk")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1Laravel\pilkasim\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>