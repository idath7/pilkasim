            ...
            <tr>
                ...
                <td>
                    <div style="display: flex; gap: 0.5rem;">
                        <button onclick="editUser(<?php echo e($user->id); ?>, '<?php echo e(addslashes($user->name)); ?>', '<?php echo e(addslashes($user->username)); ?>', '<?php echo e(addslashes($user->email)); ?>', '<?php echo e($user->role); ?>')" class="btn" style="padding: 0; font-size: 0.875rem; background-color: transparent; color: var(--primary); border: 1px solid transparent; transition: all 0.2s; border-radius: 6px; display: flex; justify-content: center; align-items: center; width: 32px; height: 32px;" title="Edit" onmouseover="this.style.backgroundColor='#e0e7ff'" onmouseout="this.style.backgroundColor='transparent'">
                            <i class="fa-solid fa-pen"></i>
                        </button>
                        <?php if(auth('admin')->id() !== $user->id): ?>
                        <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" onsubmit="confirmAction(event, 'Apakah Anda yakin ingin menghapus akun ini?');" style="margin: 0;">
                            <?php echo csrf_field(); ?>
            ...
            <div class="form-group" id="importStudentGroup">
                ...
                <select id="studentSelect" onchange="fillUserData(this)" class="select2-search">
                    ...
                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($student->name); ?>" data-username="<?php echo e($student->username); ?>"><?php echo e($student->name); ?> (<?php echo e($student->nis ?? $student->username); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div class="form-group" id="importTeacherGroup" style="display:none;">
                ...
                <select id="teacherSelect" onchange="fillUserData(this)" class="select2-search">
                    ...
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($teacher->name); ?>" data-username="<?php echo e($teacher->username); ?>"><?php echo e($teacher->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1Laravel\pilkasim\resources\views\admin\users.blade.php ENDPATH**/ ?>