...
<head>
    ...
    <title>Scanner | <?php echo e($appSetting->app_name ?? 'E-Pilketos'); ?></title>
    ...
    <script src="<?php echo e(asset('Assets/vendor/html5-qrcode.min.js')); ?>" type="text/javascript"></script>
    <style>
        body {
        ...
        #reader select:focus {
            border-color: <?php echo e($appSetting->theme_color_1 ?? '#2db8a6'); ?>;
        }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            #reader select:focus {
                border-color: <?php echo e($appSetting->theme_color_3 ?? '#f59e0b'); ?>;
            }
            #reader button {
...
<body>
    ...
    <div class="scanner-container">
        ...
        <div class="scanner-overlay">
            <i class="fa-solid fa-qrcode" style="font-size: 2rem; color: <?php echo e($appSetting->theme_color_3 ?? '#f59e0b'); ?>; margin-bottom: 0.5rem;"></i>
    ...
    <div style="display: flex; gap: 1rem; justify-content: center; width: 100%; max-width: 500px; margin-top: 1rem;">
        ...
        <a href="<?php echo e(url('/')); ?>" class="btn-back" style="margin-top: 0; flex: 1;">
...
<?php /**PATH D:\1Laravel\pilkasim\resources\views\scanner\index.blade.php ENDPATH**/ ?>