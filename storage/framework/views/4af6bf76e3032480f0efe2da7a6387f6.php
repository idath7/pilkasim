...
<head>
    ...
    <title>Kiosk Auth | <?php echo e($appSetting->app_name ?? 'E-Pilketos'); ?></title>
    ...
    <style>
        :root {
            --primary: <?php echo e($appSetting->theme_color_1 ?? '#4F46E5'); ?>;
            --primary-hover: <?php echo e($appSetting->theme_color_2 ?? '#4338CA'); ?>;
            --background: #F3F4F6;
            --surface: #FFFFFF;
            --text-main: #111827;
            --text-muted: #6B7280;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        body {
            ...
            background-image: url('<?php echo e($appSetting->main_image ?? ""); ?>');
...
<body>
    ...
    <div class="auth-card">
        <?php if($appSetting->school_logo): ?>
            <img src="<?php echo e($appSetting->school_logo); ?>" alt="Logo" class="logo">
        <?php endif; ?>
        ...
        <?php if(session('error')): ?>
            <div class="alert"><i class="fa-solid fa-triangle-exclamation"></i> <?php echo e(session('error')); ?></div>
        <?php endif; ?>

        <form action="<?php echo e(route('kiosk.login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\1Laravel\pilkasim\resources\views\kiosk\login.blade.php ENDPATH**/ ?>